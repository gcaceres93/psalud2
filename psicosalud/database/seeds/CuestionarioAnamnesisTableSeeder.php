...
class CuestionarioAnamnesisTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('cuestionario_anamnesis')->insert(array(
            ...
            array('pregunta'=>'C.C.','aclaracion_pregunta'=>'Control Cefálico, cuando sostuvo su cabeza','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>8),
            array('pregunta'=>'C.T.','aclaracion_pregunta'=>'Cuando se sentó','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>9),
            array('pregunta'=>'G.T.','aclaracion_pregunta'=>'Cuando empezó a gatear','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>10),
            array('pregunta'=>'B.D.','aclaracion_pregunta'=>'Cuando se sostuvo parado','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>11),
            array('pregunta'=>'Cuando caminó','aclaracion_pregunta'=>'','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>12),
            array('pregunta'=>'Cuando habló primeras palabras','aclaracion_pregunta'=>'','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>13),
            array('pregunta'=>'Cuando habló claro','aclaracion_pregunta'=>'','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>14),
            array('pregunta'=>'C.E.','aclaracion_pregunta'=>'Coeficiente emocional, como se percata de las emociones','grupo'=>'DESARROLLO MOTOR  Y DEL LENGUAJE:','orden'=>15),
