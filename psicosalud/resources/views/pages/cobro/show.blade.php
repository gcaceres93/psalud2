...
<div class="form-group">
                ...
                <select  disabled name="factura_id" id="factura_id"    value ="" class="form-control selectpicker">
  	...
  	<div class="form-group">
          			...
          			<select disabled  name="tipo_pago" id="tipo_pago"  class="form-control selectpicker">
          	...
          	<div class="form-group">
          			...
          			<input disabled type="number" name="monto_a_cobrar"  id="monto_a_cobrar"  class="form-control" value="{{$cobros->monto}}"placeholder="Monto" > 	
          	</div>
          	<div class="form-group">
          			<label for="observacion">Observacion:</label>
          			<input type="test" disabled name="observacion" id="observacion"  value="{{$cobros->observacion}}" class="form-control" required placeholder="Observacion" > 	
          	</div>
